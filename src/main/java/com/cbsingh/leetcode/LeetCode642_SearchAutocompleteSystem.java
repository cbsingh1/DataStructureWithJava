...
public class LeetCode642_SearchAutocompleteSystem {
    public static void main(String[] args) {
        String []sentences = {"i love you", "island", "iroman", "i love leetcode"};
        int []times = {5,3,2,2};
        LeetCode642_SearchAutocompleteSystem obj = new LeetCode642_SearchAutocompleteSystem(sentences, times);
    ...
    TrieNode cur;
    StringBuilder sb;
    public LeetCode642_SearchAutocompleteSystem(String[] sentences, int[] times) {
        root = new TrieNode();
        cur = root;
